...
import {
  ...
  Zap, Bell, BellOff, Trash2, Plus, Eye, X, Activity,
} from "lucide-react";
import {
  fetchSignals, fetchActivity, fetchWatchlist, fetchAlertRules,
  addToWatchlist, removeFromWatchlist, createAlertRule, deleteAlertRule,
              ...
              <div className="flex flex-col">
                {alertRules.map((rule) => (
                  <div
                    ...
                    style={{ borderBottom: "1px solid rgba(56, 62, 71, 0.13)", opacity: rule.enabled ? 1 : 0.5 }}
                  >
                    <div className="flex-1 min-w-0">
